    ...
    // cron.schedule('*/03 * * * *', async() => {
        const addotherlivemarketcronFunc = async() => {
            try{
                ...
                let eventIds3 = await client.get(`crone_getEventIds_Election_diamond`);
                let eventIds4 = await client.get(`crone_getEventIds_Kabaddi_diamond`);
                let eventIds5 = await client.get(`crone_getEventIds_GreyHound_diamond`);
                let eventIds6 = await client.get(`crone_getEventIds_HorseRacing_diamond`);
